...
{
    if ([self isIOS7] && leftBarButtonItem && (leftBarButtonItem.customView !=nil || leftBarButtonItem.image !=nil/* || !leftBarButtonItem.title*/)) {
...
- (void)mk_setRightBarButtonItem:(UIBarButtonItem *)rightBarButtonItem
{
    ...
    if ([self isIOS7] && rightBarButtonItem && (rightBarButtonItem.customView !=nil || rightBarButtonItem.image != nil/* || !rightBarButtonItem.title*/)) {
